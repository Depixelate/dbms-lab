...
Rem: 5. Display the laureates (name,category,aff_role,country) whose name starts with “A” orends with “a”, but not from Isreal.
...
select name, gender, aff_role, dob as "Born 1950", country from nobel where EXTRACT(YEAR from dob) BETWEEN 1950 AND 1959;
